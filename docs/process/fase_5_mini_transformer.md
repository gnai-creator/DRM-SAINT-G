...
Esta fase valida SAINT-G em um modelo com matrizes acopladas por uma loss global,
...
- `mini_SAINT-G_dynamic_delta`: codebook SAINT-G por blocos com escala, bias e residual.
...
- SAINT-G aprende quando varias matrizes estao acopladas?
...
- SAINT-G reduzir loss em relacao ao modelo base;
- SAINT-G vencer ou empatar LoRA/baseline eficiente quando ela for adicionada;
- SAINT-G vencer `mini_block_budgeted_delta` ou `mini_budgeted_delta` em pelo menos alguns regimes;
...
|---|---:|---:|---:|---:|
| mini_SAINT-G_dynamic_delta | 4 | 0.00001998 | 48.0 | 0.0000000205 |
| mini_full_delta | 4 | 0.00002063 | 160.0 | 0.0000000021 |
| mini_budgeted_delta_for_SAINT-G | 4 | 0.00002063 | 48.0 | 0.0000000070 |
| mini_block_budgeted_delta_for_SAINT-G | 4 | 0.00002064 | 48.0 | 0.0000000068 |

Leitura:

```text
SAINT-G venceu os controles neste primeiro teste pequeno,
...
- `mini_SAINT-G_per_matrix_delta`, com codebook separado por matriz;
- `mini_SAINT-G_dynamic_delta`, com codebook global compartilhado entre matrizes;
...
| Metodo | Runs | Test Loss Medio | Params Medios | Ganho/Parametro |
|---|---:|---:|---:|---:|
| mini_SAINT-G_per_matrix_delta | 4 | 0.00019998 | 72.0 | 0.0000001269 |
| mini_SAINT-G_dynamic_delta | 4 | 0.00020029 | 48.0 | 0.0000001838 |
| mini_full_delta | 4 | 0.00020591 | 160.0 | 0.0000000201 |
| mini_budgeted_delta_for_SAINT-G | 4 | 0.00020591 | 48.0 | 0.0000000667 |
| mini_block_budgeted_delta_for_SAINT-G | 4 | 0.00020598 | 48.0 | 0.0000000653 |
...
consolidacao global eficiente contra SAINT-G por matriz: 4/4
```

Leitura:

```text
SAINT-G global ficou ligeiramente pior que SAINT-G por matriz em loss media,
...
4. Levar `mini_SAINT-G_dynamic_delta` como baseline inicial.
