...
def main() -> int:
    ...
    parser.add_argument("--candidate-activations", nargs="*", default=None); parser.add_argument("--candidate-score-mode", choices=["composed_gain", "composed_gain_orthogonal", "composed_gain_ntk_hybrid_conservative", "composed_gain_cost_aware"], default="composed_gain")
    ...
    parser.add_argument("--cost-aware-lambda-params", type=float, default=0.0); parser.add_argument("--cost-aware-lambda-bytes", type=float, default=0.0); parser.add_argument("--cost-aware-lambda-time", type=float, default=0.0); parser.add_argument("--cost-aware-lambda-ntk-risk", type=float, default=1.0)
    parser.add_argument("--cost-aware-params-per-graft", type=int, default=0); parser.add_argument("--cost-aware-checkpoint-bytes-delta", type=int, default=0)
